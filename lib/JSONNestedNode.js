...
var JSONNestedNode = (_temp = _class = function (_React$Component) {
  ...
  function JSONNestedNode(props) {
    ...
    _this.handleExpandClick = function (e) {
      if (_this.props.shouldToggleExpand(e)) {
  ...
  JSONNestedNode.prototype.render = function render() {
    ...
    var stylingArgs = [keyPath, nodeType, expanded, expandable, hover];

    return hideRoot ? _react2['default'].createElement(
      'li',
      (0, _extends3['default'])({}, styling.apply(undefined, ['rootNode'].concat(stylingArgs)), { onClick: this.handleNodeClick }),
      ...
      'li',
      (0, _extends3['default'])({}, styling.apply(undefined, ['nestedNode'].concat(stylingArgs)), {
  ...
  maxClickableNodeDepth: _propTypes2['default'].number,
  onNodeClick: _propTypes2['default'].func,
  onMouseOver: _propTypes2['default'].func,
  shouldToggleExpand: _propTypes2['default'].func
}, _class.defaultProps = {
  data: [],
  circularCache: [],
  level: 0,
  expandable: true,
  shouldToggleExpand: function shouldToggleExpand() {
    return true;
  }
}, _temp);
